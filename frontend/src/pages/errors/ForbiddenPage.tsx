/**
 * VELTO — 403 Access Denied Page
 */

import { Link } from 'react-router-dom';
import { motion } from 'framer-motion';
import { Lock, Home, Zap } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-obsidian-950 flex flex-col justify-between p-6">
      ...
      <div className="max-w-md mx-auto text-center my-auto">
        ...
        >
          You don't have permission to access this resource or feature. Please log in with an authorized account.
        </motion.p>
        ...
        >
          <Link to="/login" className="w-full sm:w-auto">
            <Button variant="primary" icon={<Lock className="w-4 h-4" />} fullWidth>
              Sign In
            </Button>
          </Link>
